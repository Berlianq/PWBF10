...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="E-canteen is a HTML landing page template built with Bootstrap to help you crate engaging presentations for SaaS apps and convert visitors into users.">
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <!-- <a class="navbar-brand logo-text page-scroll" href="index.html">E-canteen</a> -->
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-5">
                        <div class="text-container">
                            <h1>Welcome to Eatme.</h1>
                            <p class="p-large">Eatme E-canteen siap memudahkan</p>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>It's very easy to start creating email lists for your marketing actions. Just create your E-canteen account</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Campaigns is a feature we've developed since the beginning because it's at the core of E-canteen's functionalities</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>E-canteen collects customer data in order to help you analyse different situations and take required action</p>
                        </div>
                    </div>
                    <!-- end of card -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="p-heading">Take your business strategy to the next level and automatize your marketing tasks to save time for product development. E-canteen can provide results in less than 2 weeks</p>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="text-container">
                                        ...
                                        <p>It's very easy to start using E-canteen. You just need to fill out and submit the <a class="blue page-scroll" href="signup">Sign Up Form</a> and you will receive access to the app and all of its features in no more than 24h.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="text-container">
                                        ...
                                        <p>Campaigns monitoring is a feature we've developed since the beginning because it's at the core of E-canteen and basically to any marketing activity focused on results.</p>
                                        <ul class="list-unstyled li-space-lg">
                                            <li class="media">
                                                <i class="fas fa-square"></i>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <hr>
                    <h5>Core service</h5>
                    <p>It's very easy to start using E-canteen. You just need to fill out and submit the Sign Up Form and you will receive access to the app.</p>
                    <ul class="list-unstyled li-space-lg">
                        <li class="media">
                    ...
                    <a class="btn-solid-reg mfp-close" href="signup">SIGN UP</a> <a class="btn-outline-reg mfp-close as-button" href="#screenshots">BACK</a>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <p>Target the right customers for your business with the help of E-canteen's patented segmentation technology and deploy efficient marketing campaigns. Keep your customers happy and loyal.</p>
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                <i class="fas fa-square"></i>
                            ...
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Targeted client base with E-canteen's efficient technology</div>
                            </li>
                        </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="p-heading">What better way to show off E-canteen marketing automation saas app than presenting you some great situations of each module and tool available to users in a video</div>        
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    </div> <!-- end of basic-2 -->
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="text-wrapper">
                                        <div class="testimonial-text">I started to use E-canteen with the free trial about a year ago and never stopped since then. It does all the repeating marketing tasks and allows me to focus on core development activities like new product research and design. I love it and recommend it to everyone.</div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="text-wrapper">
                                        <div class="testimonial-text">Awesome features for the money. I never thought such a low ammount of money would bring me so many leads per month. Before E-canteen I used the services of an agency which cost 10x more and delivered far less. Highly recommended to marketers focused on results.</div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="text-wrapper">
                                        <div class="testimonial-text">E-canteen is the best marketing automation app for small and medium sized business. It understands the mindset of young entrepreneurs and provides the necessary data for wise marketing decisions. Just give it a try and you will definitely not regret spending your time.</div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="text-wrapper">
                                        <div class="testimonial-text">E-canteen is one of the greatest marketing automation apps out there. I especially love the Reporting Tools module because it gives me such a great amount of information based on little amounts of input gathered in just few weeks of light weight usage. Recommended!</div>
                    ...
                    <div class="text-container">
                        ...
                        <form id="newsletterForm" data-toggle="validator" data-focus="false">
                            ...
                            <div class="form-group checkbox">
                                <input type="checkbox" id="nterms" value="Agreed-to-Terms" required>I've read and agree to E-canteen's written <a href="privacy-policy.html">Privacy Policy</a> and <a href="terms-conditions.html">Terms Conditions</a> 
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="footer-col last">
                        ...
                        <ul class="list-unstyled li-space-lg p-small">
                            ...
                            <li class="media">
                                ...
                                <div class="media-body"><a class="white" href="mailto:contact@E-canteen.com">contact@E-canteen.com</a> <i class="fas fa-globe"></i><a class="white" href="#your-link">www.E-canteen.com</a></div>
                            </li>
                        </ul>
                    </div> 
                </div> <!-- end of col -->
...
</html><?php /**PATH C:\Users\ACER\Documents\GitHub\PWBF10\e-canteen\resources\views/index.blade.php ENDPATH**/ ?>