    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__cart">
            <ul>
                ...
                <li>
                    ...
                    <a class="text-black" href="{{ route('home.cart-foods') }}">
        ...
        <div class="humberger__menu__widget">
            ...
            <div class="header__top__right__auth">
                ...
                <a href="#" onclick="document.getElementById('form-logout').submit()"><i class="fa fa-user"></i>
                    Logout</a>
                @endauth
                <form action="{{ route('auth.logout') }}" method="post" class="d-none" id="form-logout">
                    @csrf
                    @method('delete')
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                @auth
                <li><a href="{{ route('home.foods') }}">Makanan & Minuman Kami</a></li>
                <li><a href="{{ route('home.pesanan-saya') }}">Pesanan Saya</a></li>
                @endauth
